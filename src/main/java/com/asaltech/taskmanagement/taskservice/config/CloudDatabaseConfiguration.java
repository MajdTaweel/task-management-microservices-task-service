...
@Configuration
@EnableMongoRepositories("com.asaltech.taskmanagement.taskservice.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.asaltech.taskmanagement.taskservice.config.dbmigrations");
